    ...
    <div className="relative py-16 bg-white overflow-hidden">
      <div className="relative px-4 sm:px-6 lg:px-8">
        <div className="text-lg max-w-prose mx-auto">
          <div className="flex justify-center items-center text-base text-indigo-600 font-semibold tracking-wide uppercase">
            <LocationMarkerIcon className="mr-1 h-5 w-5 text-gray-400" />
            {data.acf.location}
          </div>
          <h1 className="mt-2 text-3xl text-center leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
            {data.title.rendered}
          </h1>
