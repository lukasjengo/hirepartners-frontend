              ...
              <div className="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                <div className="-mt-6">
                  ...
                  <p className="mt-5 text-base text-gray-500">
                    Trumpalaikis bendradarbiavimas dėl vienos ar keletos
                    pozicijų. Bendradarbiavimas esant didesniam atrankų kiekiui,
                    nuolat atsinaujinančios pozicijos.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="pt-6">
              <div className="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                <div className="-mt-6">
                  ...
                  <p className="mt-5 text-base text-gray-500">
                    Darbas įmonės viduje sutartam laikotarpiui.
                  </p>
                </div>
              </div>
            </div>
