...
export const JobSkeleton = () => (
  <div className="py-12 px-4 sm:px-6 lg:px-8">
    <div className="text-lg max-w-prose mx-auto">
      ...
      <div className="mt-16">
        <div className="mt-4 rounded-sm h-1 w-auto bg-gray-500" />
        <div className="mt-4 rounded-sm h-1 w-auto bg-gray-500" />
        <div className="mt-4 rounded-sm h-1 w-auto bg-gray-500" />
        <div className="mt-4 rounded-sm h-1 w-96 bg-gray-500" />
      </div>
    </div>
    <div className="mt-6 prose prose-lg text-gray-500 mx-auto">
      <h2>We expect you are:</h2>
      <div>
        <div className="mt-4 rounded-sm h-1 w-72 bg-gray-500" />
        <div className="mt-4 rounded-sm h-1 w-72 bg-gray-500" />
        <div className="mt-4 rounded-sm h-1 w-72 bg-gray-500" />
      </div>
